How to contribute to Cozy cozy-konnector-facebook?
====================================
...
- What is the version of the Cozy cozy-konnector-facebook?
...
```
$ git clone github.com/konnectors/cozy-konnector-facebook.git
$ cd cozy-konnector-facebook
$ git remote add fork git://github.com/yourusername/cozy-konnector-facebook.git
```
...
Go to https://github.com/yourusername/cozy-konnector-facebook and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy cozy-konnector-facebook is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/konnectors/cozy-konnector-facebook/issues/new
...
[localization]: https://github.com/konnectors/cozy-konnector-facebook/blob/master/README.md#localization
